...
import com.gstsgy.message.websocket.subscriber.LoginSubscriber;
 ...
 */
@Component
public class LoginPublisherFactory implements Publisher<Long, Object> {
    @Override
    public List<? extends Subscriber<Long, Object>> getSubscriber() {
        return SpringUtils.getBeans(LoginSubscriber.class);
    }
}
